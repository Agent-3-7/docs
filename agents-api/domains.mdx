...
Custom domains are a paid feature: they unlock once your workspace's top-ups total \$100, the same tier that raises the instance limit to 50. Below it, registration returns `403 tier_limit`; email vishnu@agent37.com to unlock them another way.
