...
<ResponseField name="agent" type="string">
  Which harness this list is for, `hermes`, `openclaw`, `claude-code`, `codex`, or `opencode`.
</ResponseField>
